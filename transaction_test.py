...
while True:
    ...
    #tx_object = prepare_tx(wallet=wallet, asset_in=USDC_ca, asset_out='8AntP7Hxft8Yjr52UQ3RnBHU4njTkDFDho97gE4vRzkt',
    #                        amount=1, mode='buy', fee='auto')
    tx_object = prepare_tx(wallet=wallet, asset_in='8AntP7Hxft8Yjr52UQ3RnBHU4njTkDFDho97gE4vRzkt',
                           asset_out=SOL_ca, mode='sell', fee='auto')
